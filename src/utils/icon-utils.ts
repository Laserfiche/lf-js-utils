/**
 * Returns the url to an svg icon from https://cdn.jsdelivr.net/npm/@laserfiche/lf-resource-library@3/resources/icons/document-icons.svg.
 * @param iconId e.g. edoc-code-20
 * @returns the url
 * @example
 * ```typescript
 * getDocumentIconUrlFromIconId('edoc-code-20'); // 'https://cdn.jsdelivr.net/npm/@laserfiche/lf-resource-library@3/resources/icons/document-icons.svg#edoc-code-20'
 * ```
 */
 export function getDocumentIconUrlFromIconId(iconId: string): string {
    return `https://cdn.jsdelivr.net/npm/@laserfiche/lf-resource-library@3/resources/icons/document-icons.svg#${iconId}`;
}

/**
 * Returns the icon id given a file extension from https://cdn.jsdelivr.net/npm/@laserfiche/lf-resource-library@3/resources/icons/document-icons.svg.
 * @param ext
 * @returns icon id
 * @example
 * ```typescript
