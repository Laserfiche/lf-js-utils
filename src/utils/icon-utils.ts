 ...
 * @example
 * ```typescript
 * getDocumentIconUrlFromIconId('edoc-code-20'); // 'https://cdn.jsdelivr.net/npm/@laserfiche/lf-resource-library@1.0.0/resources/icons/document-icons.svg#edoc-code-20'
 * ```
 */
